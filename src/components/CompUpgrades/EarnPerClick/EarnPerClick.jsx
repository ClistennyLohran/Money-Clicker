import styles from './EarnPerClick.module.css';
...
export default function EarnPerClick({ item, list, maxLevel }) {
  ...
  const { balance, setBalance, gpcValue, setGpcValue, setNotificationType, gpcBoost, gpcMultiply, gpcRebirthBoost } = useContext(ValuesContext);
  ...
  return (
    <div className={styles.container}>
      ...
      <button 
        data-tip={`Acrescenta ${ValueFormatter(parseFloat((((item.gpcAmount * (gpcBoost + gpcRebirthBoost)) * gpcMultiply))))} de GPC<br>(Ganho por Clique)`}
